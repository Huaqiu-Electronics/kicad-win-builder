...
;Install details
LangString INSTALLING_APPS ${LANG_SIMPCHINESE} "安装应用程序..."
LangString INSTALLING_SCH_LIBS ${LANG_SIMPCHINESE} "安装原理图库..."
LangString INSTALLING_PCB_LIBS ${LANG_SIMPCHINESE} "安装 PCB 库..."
LangString INSTALLING_3D_MODELS ${LANG_SIMPCHINESE} "安装 3D 模型..."
LangString INSTALLING_FOOTPRINT_WIZARDS ${LANG_SIMPCHINESE} "安装封装向导..."
LangString INSTALLING_DEMOS ${LANG_SIMPCHINESE} "安装演示..."
LangString INSTALLING_DOCUMENTATION ${LANG_SIMPCHINESE} "安装文档..."
LangString SETTING_FILE_ASSOCS ${LANG_SIMPCHINESE} "设置文件关联..."
LangString CREATING_SHORTCUTS ${LANG_SIMPCHINESE} "创建快捷方式..."
LangString CREATING_PROGRAM_ENTRY ${LANG_SIMPCHINESE} "创建程序入口..."
LangString REMOVING_SHORTCUTS ${LANG_SIMPCHINESE} "删除快捷方式..."
LangString REMOVING_APP ${LANG_SIMPCHINESE} "删除应用程序..."
LangString REMOVING_LIBRARIES ${LANG_SIMPCHINESE} "删除库..."
LangString REMOVING_DOCS ${LANG_SIMPCHINESE} "删除文档..."
LangString REMOVING_ENV_VARS ${LANG_SIMPCHINESE} "删除环境变量..."
LangString REMOVING_FILE_ASSOC ${LANG_SIMPCHINESE} "删除文件关联..."
