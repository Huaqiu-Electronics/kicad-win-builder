...
Section -CreateShortcuts
  ...
  CreateShortCut "${SMPATH}\Schematic Editor ${KICAD_VERSION} (standalone).lnk" "$INSTDIR\bin\eeschema.exe"
  CreateShortCut "${SMPATH}\PCB Editor ${KICAD_VERSION} (standalone).lnk" "$INSTDIR\bin\pcbnew.exe"
