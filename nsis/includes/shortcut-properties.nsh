...
;;;
; Sets specified AppID as File-Property in the way needed for Toast Notifications
; Pushes return-value (Windows HRESULT) to stack (0: Success)
; Example: !insertmacro ShortcutSetAppId "$SMPROGRAMS\test.lnk" "com.example.nsisdemo" ;
...
;;;
!macro ShortcutSetAppId ShortcutPath AppID
